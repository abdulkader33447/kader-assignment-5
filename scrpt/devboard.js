...
const button1 = document
  ...
  .addEventListener("click", function () {
    ...
    div.innerHTML = `
    <h2>'You have Complete The Task Fix Mobile Button Issue at ${newTime}'</h2>
    `;
...
const button3 = document
  ...
  .addEventListener("click", function () {
    ...
    div.innerHTML = `
    <h2>'You have Complete The Task Optimize Home page  at ${newTime}'</h2>
    `;
    activity.appendChild(div);
...
const button4 = document
  ...
  .addEventListener("click", function () {
    ...
    div.innerHTML = `
    <h2>'You have Complete The Task Add new emoji 🤲 at ${newTime}'</h2>
    `;
    activity.appendChild(div);
...
const button5 = document
  ...
  .addEventListener("click", function () {
    ...
    div.innerHTML = `
    <h2>'You have Complete The Task Integrate OpenAI API at ${newTime}'</h2>
    `;
    activity.appendChild(div);
...
const button6 = document
  ...
  .addEventListener("click", function () {
    ...
    div.innerHTML = `
    <h2>'You have Complete The Task Improve Job searching at ${newTime}'</h2>
    `;
    activity.appendChild(div);
